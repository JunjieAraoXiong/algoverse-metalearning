#!/bin/bash
# Experiment: optimal_hypothesis_1
# Description: Large chunks (3000) + k=20 + all features
# Generated: 2025-11-23T18:22:13.247569
...
echo "=========================================="
echo "Running: optimal_hypothesis_1"
echo "=========================================="
...
python src/bulk_testing.py \
    ...
    --max-tokens 512 \
    --use-llm-judge \
    2>&1 | tee "/Users/hansonxiong/Desktop/algoverse/LLM_as_a_Judge/experiments/results/optimal_hypothesis_1.log"
...
for f in "/Users/hansonxiong/Desktop/algoverse/LLM_as_a_Judge/experiments/results"/*.csv; do
    if [[ -f "$f" && ! "$f" == *"optimal_hypothesis_1"* ]]; then
        mv "$f" "/Users/hansonxiong/Desktop/algoverse/LLM_as_a_Judge/experiments/results/optimal_hypothesis_1_$(basename $f)"
    fi
done
