#!/bin/bash
# Experiment: chunk_standard_1500
# Description: Standard character chunking - 1500 chars
# Generated: 2025-11-23T18:22:13.246091
...
echo "=========================================="
echo "Running: chunk_standard_1500"
echo "=========================================="
...
python src/bulk_testing.py \
    ...
    --max-tokens 512 \
    --use-llm-judge \
    2>&1 | tee "/Users/hansonxiong/Desktop/algoverse/LLM_as_a_Judge/experiments/results/chunk_standard_1500.log"
...
for f in "/Users/hansonxiong/Desktop/algoverse/LLM_as_a_Judge/experiments/results"/*.csv; do
    if [[ -f "$f" && ! "$f" == *"chunk_standard_1500"* ]]; then
        mv "$f" "/Users/hansonxiong/Desktop/algoverse/LLM_as_a_Judge/experiments/results/chunk_standard_1500_$(basename $f)"
    fi
done
