#!/bin/bash
# Experiment: chunk_element_1000
# Description: Element-based chunking - 1000 max chars
# Generated: 2025-11-23T18:22:13.246017
...
echo "=========================================="
echo "Running: chunk_element_1000"
echo "=========================================="
...
python src/bulk_testing.py \
    ...
    --max-tokens 512 \
    --use-llm-judge \
    2>&1 | tee "/Users/hansonxiong/Desktop/algoverse/LLM_as_a_Judge/experiments/results/chunk_element_1000.log"
...
for f in "/Users/hansonxiong/Desktop/algoverse/LLM_as_a_Judge/experiments/results"/*.csv; do
    if [[ -f "$f" && ! "$f" == *"chunk_element_1000"* ]]; then
        mv "$f" "/Users/hansonxiong/Desktop/algoverse/LLM_as_a_Judge/experiments/results/chunk_element_1000_$(basename $f)"
    fi
done
